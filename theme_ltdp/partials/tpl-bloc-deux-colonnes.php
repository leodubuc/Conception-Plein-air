            ...
            <?php if( have_rows('bloc_info_columns_left_card') ): ?>
                <?php while( have_rows('bloc_info_columns_left_card') ) : the_row(); ?>
                    ...
                    <div data-scrolly="fromLeft" class="card personneaidante">
                        ...
                        <div class="content">
                            <ul>
                                <?php if( have_rows('bloc_info_columns_left_card_list') ): ?>
                                    <?php while( have_rows('bloc_info_columns_left_card_list') ) : the_row(); ?>

                                        <li><?php the_sub_field('bloc_info_columns_left_card_list_element'); ?></li>
